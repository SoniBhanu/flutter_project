...
import 'package:flutter_project/screens/categories.dart';
import 'package:flutter_project/screens/user.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          unselectedItemColor:
              _isDark ? Colors.grey : Color.fromARGB(255, 105, 103, 103),
          selectedItemColor: _isDark ? Colors.green : Colors.black87,
          onTap: _selectedPage,
